...
export default function UploadTreCimePage() {
  ...
  return (
    <div className="max-w-xl mx-auto p-8">
      ...
      <p className="text-gray-600 mb-4">This will overwrite <code>/public/destinations/dolomites/tre-cime/primary.jpg</code>.</p>
      ...
      <div className="mt-6 text-sm text-gray-600">
        After upload, open <a className="text-blue-600 underline" href="/destinations/dolomites/tre-cime/primary.jpg" target="_blank">this link</a> to verify, then hard refresh your Select Photos page.
      </div>
    </div>
  )
}
